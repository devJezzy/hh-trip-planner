...
interface PlanPropsContext {
  ...
  tours: { imageSrc: string; name: string; description: string; duration: string; location: string }[];
  OtherTourPlan: { imageSrc: string; name: string; description: string; duration: string; location: string }[];
}
...
export const PlanProvider: React.FC<PlanProviderProps> = ({ children }) => {
  ...
  return (
    <PlanContext.Provider value={{ tourPlan, setTourPlan, hotels, tours, OtherTourPlan }}>
      {children}
