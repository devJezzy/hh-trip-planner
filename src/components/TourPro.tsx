    ...
    <div className="flex flex-col py-px bg-white rounded-lg border border-solid border-zinc-100">
      ...
      <div className="flex flex-col px-4 py-3 rounded-none">
        ...
        <div className="flex flex-wrap gap-1 pt-2 mt-6 leading-[143%]">
          <div className="justify-center px-2.5 py-px rounded-full border border border-solid bg-neutral-200">
            {duration}
          </div>
          <div className="justify-center px-2.5 py-px whitespace-nowrap rounded-full border border border-solid bg-neutral-200">
            {location}
          </div>
        </div>
      </div>
